...
const Profile = () => {
  ...
  const profileDetails = [
    { name: 'arrow-alt-circle-up', title: 'Email', value: user?.email || 'example@gmail.com' },
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View className='px-5 py-8'>
          <View className='flex-row justify-between'>
            <Text className='text-2xl font-pbold text-gray-400 dark:text-textPrimary'>Profile</Text>
            <TouchableOpacity>
          ...
          <View className='items-center gap-2 py-5'>
            <View className='relative w-[108px] h-[108px] '>
              ...
              <TouchableOpacity onPress={pickImage} className='absolute right-0 bottom-0'>
                <Text className='font-plight text-lg text-[#F79E1B]'>Edit</Text>
              </TouchableOpacity>
            </View>
