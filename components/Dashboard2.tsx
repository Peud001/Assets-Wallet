...
const Dashboard2 = () => {
  ...
  return (
    <View className='w-full bg-white rounded-2xl shadow-sm items-center p-5 my-5 bg-[#1D1F2B]'>
      <View className='w-full flex-row justify-between'>
      <View>
        <Text className='text-[#c0c0c0]'>Current Balance</Text>
        <Text className='text-2xl font-bold text-white text-[#c0c0c0]'>$319000</Text>
      </View>
